...
class UploadController {
    ...
    uploadChunk(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { ETag, PartNumber } = yield uploadservice_1.uploadService.uploadChunk(uploadId, key, chunkBuffer, metadata);
    ...
    getPartsByKey(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const parts = yield uploadservice_1.uploadService.getUploadedParts(uploadId, key);
                res.json({ parts });
            }
            catch (error) {
